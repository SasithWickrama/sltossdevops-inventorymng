@extends('layouts.app', ['page' => __('Inventory Job Inbox'), 'pageSlug' => 'inventoryProjectInbox'])
            ...
            <div class="card-body">
                ...
                <form action="" method="POST" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            <h6 for="project_status">{{ _('Inventory Status') }}</h6>
                            <select name="project_status" id="project_status" class="form-control">
                                <option value=""></option>
                                @if(!$invstatus==null)
                                @foreach($invstatus as $data)
                                <option value="{{ $data }}">{{ $data }}</option>
                                @endforeach
                                @endif
                            </select>
